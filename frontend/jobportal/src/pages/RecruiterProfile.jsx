...
import { 
  FiUser, FiMail, FiPhone, FiBriefcase, FiLinkedin, 
  FiEdit, FiSave, FiRefreshCw, FiCheck, FiX 
} from "react-icons/fi";
                ...
                <div style={successPopupHeaderStyle}>
                    ...
                    <div style={successPopupContentStyle}>
                        ...
                        <p style={successPopupMessageStyle}>
                            Your recruiter profile has been updated. Candidates will see your latest details.
                        </p>
                    </div>
                    <button 
            ...
            <div style={contentContainerStyle}>
                ...
                <div style={headerStyle}>
                    ...
                    <div style={infoCardStyle}>
                        ...
                        <div>
                            <div style={infoTitleStyle}>Profile Preview</div>
                        ...
                        <div style={previewCardStyle}>
                            <div style={previewHeaderStyle}>
                                <h3 style={previewTitleStyle}>
                                    <FiUser size={20} style={{ marginRight: 10, color: '#4f46e5' }} />
                                    Profile Preview
                                </h3>
                            ...
                            {form.bio && (
                                <div style={previewBioSectionStyle}>
                                    <h4 style={previewBioTitleStyle}>About</h4>
                            ...
                            <div style={previewHintStyle}>
                                ...
                                <div style={previewHintTextStyle}>
                                    A complete profile builds trust with candidates
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div style={formGridStyle}>
                                    ...
                                    <div style={formGroupStyle}>
                                        ...
                                        <div style={formHelperStyle}>
                                            Your real name builds credibility
                                        </div>
                                    </div>
                                    ...
                                    <div style={formGroupStyle}>
                                        <label style={formLabelStyle}>
                                            <FiLinkedin size={14} style={{ marginRight: 6 }} />
                                            LinkedIn Profile
                                        </label>
                                        <input
                                            type="url"
                                        ...
                                        <div style={formGroupStyle}>
                                            ...
                                            <div style={bioHelperStyle}>
                                                <div style={bioTipStyle}>
                                                    💡 <strong>Example:</strong> "5+ years hiring for product-based companies. Mostly hire SDEs, data engineers, and ML roles."
                                                </div>
